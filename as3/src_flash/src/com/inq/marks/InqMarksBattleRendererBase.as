package com.inq.marks
{
    ...
    public class InqMarksBattleRendererBase extends Sprite
    {
        ...
        private var _minimalRenderer:InqMarksMinRenderer;
        ...
        public function InqMarksBattleRendererBase()
        {
            super();
            mouseEnabled  = true;
            mouseChildren = true;
        ...
        private function _drawNeerStyle():void
        {
            ...
            {
                _neerRenderer = new InqMarksNeerRenderer();
        ...
        private function _drawMinimalStyle():void
        {
            ...
            {
                _minimalRenderer = new InqMarksMinRenderer();
