...
Мітка працює тільки у випадкових боях.
...
Усередині `.wotmod` знаходяться рівно сім файлів: `meta.xml`, один `.pyc`, два SWF і три локалізації. Пакет створюється без ZIP-стиснення.
